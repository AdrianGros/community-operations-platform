...
| Operations mindset | `overview/architecture.md`, `evidence/sanitization-notes.md`, `overview/release-framing.md` | Shows the system was treated as software that has to run, not just code that compiles. |
